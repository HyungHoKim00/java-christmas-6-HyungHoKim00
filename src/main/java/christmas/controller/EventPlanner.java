...
public class EventPlanner {
    ...
    private void printBenefit(int totalOrderPriceBefore) {
        ...
        Map<String, Integer> discountDetails = getDiscountDetails(totalOrderPriceBefore);
        ...
        String badge = Badge.determineBadge(totalDiscount).inKorean();
        outputView.printEventBadge(badge);
    }

    private Map<String, Integer> getDiscountDetails(int totalOrderPriceBefore) {
        ...
        if (totalOrderPriceBefore >= LEAST_ORDER_PRICE_FOR_DISCOUNT) {
            ...
            discountDetails.entrySet().removeIf(entry -> entry.getValue() == 0);
        }
        return discountDetails;
    }

    private int getTotalDiscount(Map<String, Integer> discountDetails) {
